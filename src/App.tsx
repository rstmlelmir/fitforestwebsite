...
type IconName = 'bolt' | 'chart' | 'calendar' | 'food' | 'shield' | 'user' | 'target' | 'play' | 'arrow'
...
function App() {
  ...
  return <div className="site-shell">
    <header className="header">
      <a className="brand" href="#top" aria-label="FitForest ana səhifə"><span className="brand-mark">✦</span><span>Fit<span>Forest</span></span></a>
    ...
    <main id="top">
      <section className="hero section-grid">
        <div className="hero-copy"><p className="eyebrow"><span className="eyebrow-dot" /> Daha məqsədli yaşa</p><h1>Öz ritmini qur.<br /><em>Gücünü izlə.</em></h1><p className="hero-text">FitForest məşqini, qidalanmanı və gündəlik proqresini bir yerdə daha planlı idarə etməyə kömək edən fitness tətbiqidir.</p><div className="hero-actions"><a className="button" href={APP_URL}>İndi başla <Icon name="arrow" /></a><a className="text-link" href="#how"><span className="play-circle"><Icon name="play" /></span> Necə işləyir?</a></div><div className="hero-note"><span className="avatar-stack"><i /><i /><i /></span><span>Planlı addımlar. Ölçülə bilən nəticələr.</span></div></div>
        <div className="phone-stage" aria-label="FitForest tətbiqinin mobil görünüşü"><div className="glow glow-one" /><div className="glow glow-two" /><div className="phone"><div className="phone-notch" /><div className="phone-screen"><div className="phone-top"><span>09:41</span><span>•••</span></div><div className="phone-greeting">Salam, Aysel <span>✦</span><small>Bu gün üçün planın hazırdır</small></div><div className="progress-card"><div><small>Həftəlik proqres</small><strong>72%</strong><span>Bu həftə əla gedirsən</span></div><div className="ring">72%</div></div><div className="phone-label">Bugünkü məşq <span>Hamısına bax</span></div><div className="workout-mini"><div className="mini-icon"><Icon name="bolt" /></div><div><strong>Full body güc</strong><small>45 dəq · Orta səviyyə</small></div><b>›</b></div><div className="phone-label">Gündəlik rasion <span>⋯</span></div><div className="nutrition-mini"><div className="bars"><i /><i /><i /><i /></div><div><strong>1,420 <small>/ 2,100 kkal</small></strong><small>Günlük hədəfin</small></div></div><div className="phone-nav"><span>⌂</span><span>⌁</span><span className="active">✦</span><span>◯</span></div></div></div></div>
      </section>

      <section className="statement section"><div className="section-kicker">FITFOREST İLƏ</div><h2>Daha planlı məşq.<br /><span>Daha düzgün qidalanma.</span><br />Daha ölçülə bilən proqres.</h2><p>Kiçik addımları davamlı vərdişlərə çevirmək üçün sadə, aydın və sənin tempinə uyğun bir yol.</p></section>

      <section className="problem section section-grid"><div><p className="eyebrow">Sənə tanışdır?</p><h2>Başlamaq asandır.<br /><em>Davam etmək üçün sistem lazımdır.</em></h2></div><div className="problem-list"><div className="problem-row"><b>01</b><div><strong>Plan qarışıqlığı</strong><p>Bu gün nə etməli olduğunu düşünmək üçün enerjini itirmə.</p></div><span>×</span></div><div className="problem-row"><b>02</b><div><strong>Nəticəni görə bilməmək</strong><p>İrəliləyişin qeydə alınmayanda motivasiya da zəifləyir.</p></div><span>×</span></div><div className="solution-row"><div className="mini-mark">✦</div><div><strong>FitForest ilə həll</strong><p>Planın, qeydlərin və proqresin bir baxışda səninlədir.</p></div><span>✓</span></div></div></section>

      <section className="features section" id="features"><div className="section-intro"><div><p className="eyebrow">Sənin gündəlik yol yoldaşın</p><h2>Bir tətbiqdə<br /><em>hər şey daha aydın.</em></h2></div><p>Məqsədindən asılı olmayaraq, ardıcıl qalmağı asanlaşdıran alətlər.</p></div><div className="feature-grid">{features.map(([icon, title, text], index) => <article className={index === 0 ? 'feature-card feature-card-featured' : 'feature-card'} key={title}><div className="feature-icon"><Icon name={icon} /></div><span className="feature-number">0{index + 1}</span><h3>{title}</h3><p>{text}</p><a href={APP_URL} aria-label={`${title} haqqında tətbiqə keç`}>Kəşf et <Icon name="arrow" /></a></article>)}</div></section>

      <section className="how section" id="how"><div className="section-intro"><div><p className="eyebrow">Sadə dörd addım</p><h2>Hərəkətə keçmək<br /><em>belə görünür.</em></h2></div></div><div className="steps"><div className="step"><span>01</span><div className="step-icon"><Icon name="user" /></div><h3>Qeydiyyatdan keç</h3><p>Hesabını yarat və öz yolunu başlat.</p></div><div className="step"><span>02</span><div className="step-icon"><Icon name="target" /></div><h3>Məqsədini müəyyən et</h3><p>Nəyə çatmaq istədiyini seç.</p></div><div className="step"><span>03</span><div className="step-icon"><Icon name="calendar" /></div><h3>Proqramını izlə</h3><p>Həftəni planla və məşqlərini tamamla.</p></div><div className="step"><span>04</span><div className="step-icon"><Icon name="chart" /></div><h3>Proqresini ölç</h3><p>Nəticələrini izləyərək davam et.</p></div></div></section>

      <section className="trust section section-grid" id="trust"><div className="trust-badge"><div className="large-shield"><Icon name="shield" /></div><span>Güvənlə<br />davam et</span></div><div><p className="eyebrow">Sənin məlumatların, sənin nəzarətində</p><h2>Məşqinə fokuslan.<br /><em>Qalanını biz qoruyaq.</em></h2><p className="trust-text">FitForest hesab məlumatlarını qorumağa və təhlükəsiz autentifikasiya axını təqdim etməyə fokuslanır. Məxfilik və təhlükəsizlik bizim üçün məhsulun əsas hissəsidir.</p><div className="trust-points"><span><Icon name="shield" /> Təhlükəsiz hesab sistemi</span><span><Icon name="target" /> Aydın və məsuliyyətli yanaşma</span></div></div></section>

      <section className="final-cta section"><div className="cta-orbit orbit-one" /><div className="cta-orbit orbit-two" /><p className="eyebrow">Bu gün başla</p><h2>Öz dəyişiminə<br /><em>yer aç.</em></h2><p>Birinci addım kiçik ola bilər. Əsas odur ki, sənə aid olsun.</p><a className="button button-light" href={APP_URL}>Tətbiqə daxil ol <Icon name="arrow" /></a></section>
    </main>
    <footer className="footer"><div className="footer-main"><a className="brand" href="#top"><span className="brand-mark">✦</span><span>Fit<span>Forest</span></span></a><p>Gündəlik gücün üçün daha aydın yol.</p><a className="footer-cta" href={APP_URL}>PWA-ya keçid <Icon name="arrow" /></a></div><div className="footer-bottom"><span>© 2026 FitForest</span><div><a href="#trust">Məxfilik siyasəti</a><a href="#trust">İstifadə şərtləri</a><a href="mailto:hello@fitforestapp.com">hello@fitforestapp.com</a></div></div></footer>
  </div>
}
